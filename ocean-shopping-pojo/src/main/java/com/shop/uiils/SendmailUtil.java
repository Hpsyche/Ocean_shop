...
public class SendmailUtil {
    ...
    //发件人邮箱
    private static String myEmailAccount = "460204715@qq.com";
    //发件人邮箱密码（授权码）
    //在开启SMTP服务时会获取到一个授权码，把授权码填在这里
    private static String myEmailPassword = "ouepemvgnclobggc";
    /**
...
//        builder.append("\n官网：" + "https://www.hbuecx.club");
        ...
        msg.setFrom(new InternetAddress(myEmailAccount, "海大小栈", "UTF-8"));
        //得到邮差对象
